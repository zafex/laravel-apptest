    ...
    'connections' => [
        ...
        'core' => [
            ...
            'read' => [
                ...
                'charset' => env('DB_CHARSET_READ') ?: env('DB_CHARSET', 'utf8'),
                'prefix' => env('DB_PREFIX_READ') ?: env('DB_PREFIX', ''),
                'schema' => env('DB_SCHEMA_READ') ?: env('DB_SCHEMA', 'public'),
                'sslmode' => env('DB_SSL_MODE_READ') ?: env('DB_SSL_MODE', 'prefer'),
            ],
            'write' => [
                'host' => env('DB_HOST_WRITE') ?: env('DB_HOST', '127.0.0.1'),
                'port' => env('DB_PORT_WRITE') ?: env('DB_PORT', 5432),
                ...
                'charset' => env('DB_CHARSET_WRITE') ?: env('DB_CHARSET', 'utf8'),
                'prefix' => env('DB_PREFIX_WRITE') ?: env('DB_PREFIX', ''),
                'schema' => env('DB_SCHEMA_WRITE') ?: env('DB_SCHEMA', 'public'),
                'sslmode' => env('DB_SSL_MODE_WRITE') ?: env('DB_SSL_MODE', 'prefer'),
            ],
        ],
